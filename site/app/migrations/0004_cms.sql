-- CMS round: owner-editable FAQ items, site copy, legal pages, admin
-- password hash and Stripe key self-service. Additive only.
...
INSERT OR IGNORE INTO faq_items (id, question, answer, sort, visible) VALUES (1, 'What is in your chocolate, and what about allergens?', 'We work with fine couverture chocolate made from cocoa mass, cocoa butter, sugar and, in milk and white varieties, milk solids. Fillings may include cream, butter, nuts, fruit and spirits. Our kitchen handles nuts, dairy, soy, gluten and egg, so all products may contain traces of these allergens even where they are not listed ingredients. A full ingredient and allergen list is supplied with every order, and we are happy to share it before you book. If any of your guests have a severe allergy, please tell us at enquiry so we can advise honestly on what we can and cannot guarantee.', 1, 1);
INSERT OR IGNORE INTO faq_items (id, question, answer, sort, visible) VALUES (2, 'Do you offer vegan or dietary-specific options?', 'Yes. Dairy-free dark chocolate pieces, vegan ganaches and alcohol-free fillings are available across most of the collection. Gluten is not an ingredient in most of our range, though we cannot certify products as gluten free because of shared equipment. Tell us what you need and we will design around it.', 2, 1);
INSERT OR IGNORE INTO faq_items (id, question, answer, sort, visible) VALUES (3, 'How far in advance should we order?', 'Our lead time is four to six weeks from design approval, and popular dates book out earlier. For weddings in October to March, we suggest enquiring three to four months ahead. If your date is closer than six weeks, write to us anyway. If we can take it on, we will.', 3, 1);
INSERT OR IGNORE INTO faq_items (id, question, answer, sort, visible) VALUES (4, 'Where do you deliver?', 'Australia-wide. Metropolitan Sydney deliveries are made by our own cold-chain courier; interstate orders travel in insulated, temperature-controlled packaging with express carriers. We schedule every delivery around your wedding date so the chocolate arrives fresh, usually two to four days before the day. International orders are considered case by case, so please enquire with your destination and date.', 4, 1);
INSERT OR IGNORE INTO faq_items (id, question, answer, sort, visible) VALUES (5, 'How should we store the chocolate before the wedding?', 'Keep boxes sealed, in a cool, dry, dark place between 15 and 20 degrees, away from strong smells. Chocolate does not like the fridge: condensation dulls the finish and can mark hand-painted work. Stored well, your bomboniere will be perfect on the day and for several weeks after.', 5, 1);
INSERT OR IGNORE INTO faq_items (id, question, answer, sort, visible) VALUES (6, 'How does the custom design process work?', 'It begins with a conversation about your wedding, then a tasting, then a written design proposal covering flavours, finishes, monograms or motifs, and packaging. You approve every detail before production begins. Small refinements are welcome up to three weeks before delivery; larger changes may adjust the quote or timeline.', 6, 1);
INSERT OR IGNORE INTO faq_items (id, question, answer, sort, visible) VALUES (7, 'What are your payment terms?', 'A 50% deposit confirms your date and design, and production is scheduled once it is received. The balance is due two weeks before delivery. We accept bank transfer and card payment, and all prices include GST.', 7, 1);
INSERT OR IGNORE INTO faq_items (id, question, answer, sort, visible) VALUES (8, 'What if we need to cancel or change our date?', 'Life happens, and weddings move. If you postpone, we will transfer your booking to a new date where our calendar allows, at no charge. If you cancel before production begins, we refund everything except costs already incurred on your design and any custom moulds or packaging. Once production has started, the deposit is non-refundable because your pieces are made only for you. None of this limits your rights under the Australian Consumer Law.', 8, 1);
INSERT OR IGNORE INTO faq_items (id, question, answer, sort, visible) VALUES (9, 'Something else?', 'Email {{contact_email}} and we will reply within two business days.', 9, 1);

-- Editable site copy (defaults equal the current live copy).
INSERT OR IGNORE INTO settings (key, value) VALUES ('hero_headline', 'Where art meets chocolate.');
INSERT OR IGNORE INTO settings (key, value) VALUES ('hero_subline', 'Handcrafted wedding bomboniere and collectible art bonbon boxes. Made to order in Australia, in small numbers, for a small number of commissions each season.');
INSERT OR IGNORE INTO settings (key, value) VALUES ('story_heading', 'Curated artisan chocolates');
INSERT OR IGNORE INTO settings (key, value) VALUES ('story_body', 'Zin Choc is not found in shops. Each piece begins as a sketch, becomes a mould, and is finished by hand in cocoa butter, gold and silver. We make wedding bomboniere the way a jeweller makes a ring: slowly, precisely, and for one couple at a time.
...
INSERT OR IGNORE INTO settings (key, value) VALUES ('closing_line_1', 'If your wedding is within six months, we recommend enquiring now.');
INSERT OR IGNORE INTO settings (key, value) VALUES ('collection_intro', 'Every piece is designed for one wedding, or made in a small collectible edition. All prices are in Australian dollars and include GST. Delivery is quoted separately, and lead time is four to six weeks from design approval.');
INSERT OR IGNORE INTO settings (key, value) VALUES ('order_notes_hint', '');

-- Admin-only settings (never exposed to public reads).
INSERT OR IGNORE INTO settings (key, value) VALUES ('admin_password_hash', '');
INSERT OR IGNORE INTO settings (key, value) VALUES ('stripe_secret_key', '');
...
INSERT OR IGNORE INTO legal_pages (slug, title, body, updated_at) VALUES ('privacy', 'Privacy Policy', 'Zin Choc ({{abn}}) respects your privacy. This policy explains what personal information we collect, why we collect it, how we hold it, and your rights. We handle personal information in accordance with the Privacy Act 1988 (Cth) and the Australian Privacy Principles (APPs). For visitors in the European Union, United Kingdom and other regions with comparable privacy laws, we also apply the additional protections described in the section "Visitors outside Australia" below.
...
We may update this policy from time to time. The current version will always be published on this page with its date of last update.', '2026-07-05');
INSERT OR IGNORE INTO legal_pages (slug, title, body, updated_at) VALUES ('terms', 'Terms of Sale', 'These terms apply to all quotes, orders and sales of Zin Choc ({{abn}}) products ("goods"). By paying a deposit you accept these terms. Nothing in these terms excludes, restricts or modifies any right or guarantee you have under the Australian Consumer Law (ACL) that cannot lawfully be excluded.
...
9.3 Questions about these terms: {{contact_email}}.', '2026-07-05');
INSERT OR IGNORE INTO legal_pages (slug, title, body, updated_at) VALUES ('shipping-refunds', 'Shipping and Refunds', 'Zin Choc ({{abn}}).
...
Email {{contact_email}} and we will reply within two business days.', '2026-07-05');
